 ...
 display:none;                                                                
  ...
  #progress_bar .percent {
    ...
    width: 0;
        ...
        <form name="fdgfd" id="fgdfgdf" enctype="multipart/form-data">
         <input type="file" id="files" name="file" multiple>
         <input type="hidden" id="conters" name="haridh" value="0" />
         <input type="button"  id="sublabee" value="submit" />
